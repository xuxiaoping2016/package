...
// Module
exports.push([module.i, ".goods-list-container-only {\n  margin-top: 10px;\n  position: relative;\n}\n.goods-list-container-only ul {\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\n.goods-list-container-only .list-header {\n  display: flex;\n  margin-bottom: 10px;\n  background: #fff;\n  border-radius: 6px;\n  font-weight: bold;\n}\n.goods-list-container-only .list-header li {\n  list-style: none;\n  flex: 1;\n  padding: 15px 10px;\n  line-height: 20px;\n  text-align: center;\n}\n.goods-list-container-only .list-header li:first-child {\n  flex: 2;\n  padding-left: 20px;\n  text-align: left;\n  position: relative;\n}\n.goods-list-container-only .list-header li:first-child :global(.ant-checkbox-wrapper) {\n  position: absolute;\n  left: -28px;\n}\n.goods-list-container-only .list-header li.has-choose {\n  padding-left: 0px;\n}\n.goods-list-container-only .no-data {\n  padding: 40px;\n  border-radius: 6px;\n  text-align: center;\n  background: #fff;\n  color: #bbb;\n}\n.goods-list-container-only .list-item {\n  list-style: none;\n  margin-bottom: 10px;\n  border: 1px solid #e8e8e8;\n  border-radius: 10px;\n  background: #fff;\n}\n.goods-list-container-only .list-item.select {\n  padding-left: 40px;\n  position: relative;\n}\n.goods-list-container-only .list-item.select .list-item-title {\n  padding-left: 0;\n}\n.goods-list-container-only .list-item.select .list-item-body .item:first-child {\n  padding-left: 0px;\n}\n.goods-list-container-only .list-item .list-item-title {\n  padding: 10px 20px;\n  border-bottom: 1px solid #e8e8e8;\n}\n.goods-list-container-only .list-item .list-item-title :global(.ant-checkbox-wrapper) {\n  position: absolute;\n  left: 12px;\n}\n.goods-list-container-only .list-item .list-item-body {\n  display: flex;\n}\n.goods-list-container-only .list-item .list-item-body .item {\n  flex: 1;\n  width: 0;\n  padding: 15px 10px;\n  text-align: center;\n}\n.goods-list-container-only .list-item .list-item-body .item:first-child {\n  flex: 2;\n  padding-left: 20px;\n  text-align: left;\n}\n.goods-list-container-only .spin {\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  left: 0;\n  top: 0;\n  padding-top: 30px;\n  text-align: center;\n  background: rgba(242, 242, 246, 0.3);\n}\n", ""]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _goodsList_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./goodsList/index.js */ "./src/goodsList/index.js");




console.log(_goodsList_index_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
/* harmony default export */ __webpack_exports__["default"] = (_goodsList_index_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
